...
function coulure(){$("#container.transmedia-2014 .title").each(function(){$(this).after('<div id="coulure"><div class="left"></div><div class="right"></div></div>')})}function openProject(){if(!projectProcess){projectProcess=!0;var t=$("#project ul").height();$("#project ul").height(0),$("#project ul").show(),$("#project ul").animate({height:t},300,function(){projectsActive=!0,projectProcess=!1})}}function closeProject(){if(!($(window).width()<500||projectProcess)){projectProcess=!0;{$("#project ul").height()}$("#project ul").animate({height:0},300,function(){projectsActive=!1,projectProcess=!1,$("#project ul").hide(),$("#project ul").height("inherit")})}}function openProjectBottom(){if(!projectBottomProcess){projectBottomProcess=!0;var t=$("#project_bottom ul").height();$("#project_bottom ul").height(0),$("#project_bottom ul").show(),$("#project_bottom ul").animate({height:t},300,function(){projectsBottomActive=!0,projectBottomProcess=!1})}}function closeProjectBottom(){if(!projectBottomProcess){projectBottomProcess=!0;{$("#project_bottom ul").height()}$("#project_bottom ul").animate({height:0},300,function(){projectsBottomActive=!1,projectBottomProcess=!1,$("#project_bottom ul").hide(),$("#project_bottom ul").height("inherit")})}}function socialColor(){var t=$("p.button a").css("background-color"),o=$(".social #facebook svg"),e=$(".social #twitter svg"),r=$(".social #instagram svg"),c=$(".social #linkedin svg"),i=$(".social #youtube svg");$("circle",o).attr("stroke",t),$("path",o).attr("fill",t),$("path",e).attr("fill",t),$("circle",r).attr("stroke",t),$("path.arround",r).attr("stroke",t),$("path.down",r).attr("fill",t),$("path.round",r).attr("fill",t),$("path.mini-round",r).attr("fill",t),$("circle",c).attr("stroke",t),$("rect",c).attr("fill",t),$("path",c).attr("fill",t),$("path.arround",i).attr("stroke",t),$("path.inside",i).attr("fill",t)}function openBurger(){if(!($(window).width()>500)){$("header nav ul li ul").show();var t=$("header nav").height(),o=-t-55;$("header nav").css("top",o),$("header nav").show(),$("header nav").animate({top:55},300,function(){burgerActive=!0}),$("header nav").css("position","fixed"),$("header").css("position","fixed"),$("header").next().css("margin-top","55px")}}function closeBurger(){var t=$("header nav").height(),o=-t-55;$("header nav").animate({top:o},300,function(){burgerActive=!1,$("header nav").hide(),$("header nav").css("position","absolute"),$("header").css("position","relative"),$("header").next().css("margin-top",0)})}var burgerActive=!1,projectsActive=!1,projectProcess=!1,projectsBottomActive=!1,projectBottomProcess=!1;$(document).ready(function(){socialColor(),coulure(),$("header").on("click","#burger",function(){burgerActive?closeBurger():openBurger()}),$("header").on("click","#project",function(){projectsActive?closeProject():openProject()}),$("footer").on("click","#project_bottom",function(){projectsBottomActive?closeProjectBottom():openProjectBottom()}),$("html").click(function(){burgerActive&&closeBurger(),projectsActive&&closeProject(),projectsBottomActive&&closeProjectBottom()}),$("html").on("click",".characteristic .content > article",function(){$(".details",this).toggle("slow")})});
function resize(){var t=$(window).width(),i=$(window).height();closeProjectBottom(),closeProject(),burgerActive&&closeBurger(),t>500?($("header nav").css("top",0),$("header nav").show(),$("header nav").css("position","relative")):($("header nav").css("position","absolute"),$("header nav").hide()),500>t?$("header ul li ul li a").each(function(){if(!$(this).hasClass("mobile")){$(this).addClass("mobile");var t=$(this).text();$(this).attr("data-txt",t),$(this).text("")}}):$("header ul li ul li a").each(function(){if($(this).hasClass("mobile")){$(this).removeClass("mobile");var t=$(this).attr("data-txt");$(this).text(t)}}),640>t?(console.log("mobile"),$("footer ul li ul li a").each(function(){if(!$(this).hasClass("mobile")){$(this).addClass("mobile");var t=$(this).text();$(this).attr("data-txt",t),$(this).text("")}})):$("footer ul li ul li a").each(function(){if($(this).hasClass("mobile")){$(this).removeClass("mobile");var t=$(this).attr("data-txt");$(this).text(t)}}),$(".player").each(function(){var t=$(this).width();$(this).css("height",9*t/16),$("iframe",this).attr("width",t),$("iframe",this).attr("height",9*t/16)}),$(".content .right").each(function(){var t=$(this),i=$(this).parent(),e=$(".left",i),s=$(e).height(),h=$(t).height();h>s?($(t).addClass("bigger"),$(e).addClass("smaller")):($(t).removeClass("bigger"),$(e).removeClass("smaller"))}),$("#coulure").each(function(){var e=$(".content").width(),s=(t-e)/2,h=$("html").height(),a=$(this).position();if(i>h)var r=i-a.top;else var r=h-a.top;$(".left",this).css("width",s),$(".right",this).css("width",s),$(".left",this).css("height",r),$(".right",this).css("height",r)}),$("article.video").each(function(){var i=$(".player",this).position(),e=$(".player",this).height(),s=$(".player",this).width();$("#left, #right",this).css("height",e);var h=$("#left",this).height(),a=i.top+e/2-h/2,r=(t-s)/2;$("#left",this).css("left",0),$("#right",this).css("right",0),$("#left, #right",this).css("top",a),$("#left, #right",this).css("width",r),$("#container > header").addClass("has_a_video")})}$(document).ready(function(){timer=setInterval(function(){resize(),clearInterval(timer)},100),$(window).resize(function(){resize()})});