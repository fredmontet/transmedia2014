...
function coulure(){$("#container.transmedia-2014 .title").each(function(){$(this).after('<div id="coulure"><div class="left"></div><div class="right"></div></div>')})}function openProject(){if(!projectProcess){projectProcess=!0;var e=$("#project ul").height();$("#project ul").height(0),$("#project ul").show(),$("#project ul").animate({height:e},300,function(){projectsActive=!0,projectProcess=!1})}}function closeProject(){if(!projectProcess){projectProcess=!0;{$("#project ul").height()}$("#project ul").animate({height:0},300,function(){projectsActive=!1,projectProcess=!1,$("#project ul").hide(),$("#project ul").height("inherit")})}}function socialColor(){var e=$("p.button a").css("background-color"),t=$(".social #facebook svg"),r=$(".social #twitter svg"),o=$(".social #instagram svg"),c=$(".social #linkedin svg"),i=$(".social #youtube svg");$("circle",t).attr("stroke",e),$("path",t).attr("fill",e),$("path",r).attr("fill",e),$("circle",o).attr("stroke",e),$("path.arround",o).attr("stroke",e),$("path.down",o).attr("fill",e),$("path.round",o).attr("fill",e),$("path.mini-round",o).attr("fill",e),$("circle",c).attr("stroke",e),$("rect",c).attr("fill",e),$("path",c).attr("fill",e),$("path.arround",i).attr("stroke",e),$("path.inside",i).attr("fill",e)}function openBurger(){var e=$("header nav").height(),t=-e-55;$("header nav").css("top",t),$("header nav").show(),$("header nav").animate({top:55},300,function(){burgerActive=!0}),$("header nav").css("position","fixed"),$("header").css("position","fixed"),$("header").next().css("margin-top","55px")}function closeBurger(){var e=$("header nav").height(),t=-e-55;$("header nav").animate({top:t},300,function(){burgerActive=!1,$("header nav").hide(),$("header nav").css("position","absolute"),$("header").css("position","relative"),$("header").next().css("margin-top",0)})}var burgerActive=!1,projectsActive=!1,projectProcess=!1;$(document).ready(function(){socialColor(),coulure(),$("header").on("click","#burger",function(){burgerActive?closeBurger():openBurger()}),$("header").on("click","#project",function(){projectsActive?closeProject():openProject()}),$("html").click(function(){burgerActive&&closeBurger(),projectsActive&&closeProject()}),$("html").on("click",".characteristic .content > article",function(){$(".details",this).toggle("slow")})});
function resize(){var t=$(window).width(),i=$(window).height();$(".player").each(function(){var t=$(this).width();$(this).css("height",9*t/16),$("iframe",this).attr("width",t),$("iframe",this).attr("height",9*t/16)}),$(".content .right").each(function(){var t=$(this),i=$(this).parent(),e=$(".left",i),h=$(e).height(),s=$(t).height();s>h?($(t).addClass("bigger"),$(e).addClass("smaller")):($(t).removeClass("bigger"),$(e).removeClass("smaller"))}),$("#coulure").each(function(){var e=$(".content").width(),h=(t-e)/2,s=$("html").height(),r=$(this).position();if(console.log(r.top),i>s)var a=i-r.top;else var a=s-r.top;$(".left",this).css("width",h),$(".right",this).css("width",h),$(".left",this).css("height",a),$(".right",this).css("height",a)}),$("article.video").each(function(){var i=$(".player",this).position(),e=$(".player",this).height(),h=$(".player",this).width();$("#left, #right",this).css("height",e);var s=$("#left",this).height(),r=i.top+e/2-s/2,a=(t-h)/2;$("#left",this).css("left",0),$("#right",this).css("right",0),$("#left, #right",this).css("top",r),$("#left, #right",this).css("width",a),$("#container > header").addClass("has_a_video")})}$(document).ready(function(){timer=setInterval(function(){resize(),clearInterval(timer)},100),$(window).resize(function(){resize()})});