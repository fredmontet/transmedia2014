...
function init(){$(".infoArticle").not("#generalInfo").hide(),$("#menu").hide()}function menu(){$("#toggleMenu").click(function(){$("#menu").slideToggle()})}function test(){console.log("je tesssssssssssssssst")}function displayInfo(e){$("#generalInfo").hide();var n=e.toString(),i=n;console.log("displayInfo ArticleToDisplay function = "+e),$(i).show()}$(document).ready(function(){init(),menu(),$(".project").mouseenter(function(){var e="#"+$(this).attr("id");Snap.select(e).animate({fill:"rgb(149, 216, 242)"},100,mina.ease)}),$(".project").mouseleave(function(){var e="#"+$(this).attr("id");Snap.select(e).animate({fill:"#010102"},100,mina.ease)}),$(".ligne").mouseenter(function(){var e="#"+$(this).attr("id");Snap.select("#ligne1").animate({fill:"#CCCCCC"},100,mina.ease),Snap.select("#ligne2").animate({fill:"#B3B3B3"},100,mina.ease),Snap.select("#ligne3").animate({fill:"#666666"},100,mina.ease),$(".infoArticle").hide(),$("#ligne1 #ligne2 #ligne3").removeClass("active"),$(this).addClass("active"),Snap.select(e).animate({fill:"rgb(149, 216, 242)"},100,mina.ease);var n=e+"Info";displayInfo(n)}),$(".pole").mouseenter(function(){var e="#"+$(this).attr("id");console.log(e),snapPole=Snap.select(e),console.log(snapPole),snapPole.selectAll().animate({fill:"#010102"},100,mina.ease)}),$(".pole").mouseleave(function(){var e="#"+$(this).attr("id");snapPole=Snap.select(e),console.log(snapPole),snapPole.selectAll().animate({fill:"#010102"},100,mina.ease)}),$(".avatar").mouseenter(function(){var e="#"+$(this).attr("id")+" .cercle";console.log(e),Snap.select(e).animate({fill:"#f4e210"},100,mina.ease)}),$(".avatar").mouseleave(function(){var e="#"+$(this).attr("id")+" .cercle";console.log(e),Snap.select(e).animate({fill:"#ffffff"},100,mina.ease)}),$("#infoButton").click(function(){$(".infoArticle").hide(),$("#generalInfo").toggle()})}),$(window).load(function(){var e=$(window).width(),n=$(window).height();console.log("width = "+e+"  height = "+n);var i=svgPanZoom("#map"),a=Math.floor($(window).width()/100*46.6),t=Math.floor($(window).height()/100*53);i.setMaxZoom(17),i.setMinZoom(1),i.zoomAtPointBy(11,{x:a,y:t})});